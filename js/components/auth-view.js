...
function settingsLinkCard() {
    return `
        <div class="card card-clickable" id="goto-settings" style="padding:16px 20px;margin-top:16px;display:flex;align-items:center;gap:12px;cursor:pointer">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--text-secondary)" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.32 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>
            <div style="flex:1">
                <div style="font-weight:600;font-size:0.9375rem">Impostazioni</div>
                <div style="font-size:0.8rem;color:var(--text-secondary)">Tema, audio, dimensione testo</div>
            </div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-tertiary)" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
        </div>
    `;
}
...
function renderNotConfigured() {
    const page = renderPage(`
        ...
        ${settingsLinkCard()}
    `);
    page.querySelector('#goto-settings')?.addEventListener('click', () => navigate('/settings'));
}
...
async function renderLoggedIn(user) {
    ...
    const page = renderPage(`
        ...
        <!-- Friends Section -->
        <div class="card" style="padding:24px;margin-bottom:16px;margin-top:16px">
